...
parser.add_argument(
    "-m", "--model", type=str, help="path to model folder")
parser.add_argument(
    "-o", "--output", type=str, default="transcript.txt",
    help="file to save transcription (default: transcript.txt)")
...
try:
    ...
    with sd.RawInputStream(samplerate=args.samplerate, blocksize=8000,
        ...
        while True:
            ...
            if rec.AcceptWaveform(data):
                ...
                # можно выводить промежуточные partial
                pass
    ...
    # сохраняем в файл при остановке
    final_text = " ".join(transcript)
    with open(args.output, "w", encoding="utf-8") as f:
        f.write(final_text)
    print("\n✅ Расшифровка сохранена в", args.output)
    parser.exit(0)
